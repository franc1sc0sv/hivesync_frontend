    ...
    <main className="flex flex-col w-full bg-overlay_1 min-h-screen">
      <div className="z-50">
        <div className=" flex flex-row p-6 justify-between items-center">
            <img className="flex h-8 p-1" src="/logo.png"></img>
          ...
          <div className="p-4">
            ...
            <div className="text-white box-border m-2 rounded-sm bg-primary p-1.5 w-36 flex flex-row justify-between items-center ">
              ...
              <img className="h-4" src="/flecha.png"></img>
            </div>
        </div>
      </div>
      <div className="p-1 z-0">
        <img className="w-40 absolute top-40 right-0" src="/moneda.png"></img>
        <img className="w-60 absolute top-60 left-40" src="/esfera.png"></img>
        <img className="w-40 absolute bottom-20 left-80 p-4" src="/cono.png"></img>
      </div>
    </main> 
  );
};