      ...
      <div className="z-50">
        <div className=" flex flex-row p-6 justify-between items-center">
            ...
            <div className="flex flex-row-reverse gap-3 m-1">
              <Link className="text-white box-border rounded-md text-1xl p-2 font-almarai bg-primary" to={"signup"}>Empezar</Link>
          ...
          <div className="p-4">
            ...
            <div className="bg-primary w-16 h-2 box-border rounded-md m-2"><button></button></div>
            <div className="text-white box-border rounded-md bg-primary p-1.5 w-max flex gap-4 flex-row justify-between items-center px-5 py-3">
              <p className="font-amiko font-bold text-sm">Usar HiveSync</p>
              <img className="h-4" src="../public/flecha.png"></img>
            </div>
        </div>
        </div>
      <div className="p-1 z-0">
        <img className="w-40 absolute top-60 right-0" src="../public/moneda.png"></img>
        <img className="w-60 absolute top-80 left-40" src="../public/esfera.png"></img>
        <img className="w-40 absolute top-100 left-80 p-4" src="../public/cono.png"></img>
      </div>
    </main> 
  );
};
